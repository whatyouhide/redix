...
port `6379`. Both may be configured using the environment variables `HOST` and
`PORT` respectively. Tests will wipe clean all the databases on the running Redis
